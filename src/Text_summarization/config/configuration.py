...
from Text_summarization.entity import (DataIngestionConfig,DataValidationConfig,DataTransformationConfig,Modeltrainerconfig,Modelvalidationrconfig)
...
class ConfigurationManager:
    ...
    def get_modevalidation_config(self) -> Modelvalidationrconfig:
        config = self.config.model_evaluation

        create_directories([config.root_dir])
        
        model_validation_config = Modelvalidationrconfig(
                root_dir= config.root_dir,
                data_path= config.data_path,
